                	...
                	<div class="row">
                		<div class="col-sm-12">
		                	<table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
		                  		<thead>
		                    		<tr role="row">
		                    			<th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 15px;">
		                    				Id
		                    			</th>
		                    			<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 269px;">
		                    				Category
		                    			</th>
		                    			<th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" aria-label="Start date: activate to sort column ascending" style="width: 90px;">
		                    				Action
		                    			</th>
		                    		</tr>
		                  		</thead>
		                  		<tbody>
		                  			...
		                  			<tr role="row" class="odd">
					                   ...
					                   <td>
					                    	<!-- Create menu items for each parent menu -->
					                    	<%MenuCreationUtil.createMenuItem(out, request, itemCategory.getId(), currentPage);%>
					                    </td>
					                    <%-- <td>
											<a href="<%=request.getContextPath()%>/admin/user/edit?page=<%=currentPage%>&id=<%=itemCategory.getId()%>" class="btn btn-info">
								          		<i class="fas fa-edit"></i>
								          		Edit
								          	</a>
											<a href="<%=request.getContextPath()%>/admin/user/del?page=<%=currentPage%>&id=<%=itemCategory.getId()%>" class="btn btn-danger"
