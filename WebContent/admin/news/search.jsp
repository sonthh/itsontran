		                  		...
		                  		<tbody>
	                            		...
	                            		if (request.getAttribute("currentPage") != null)
		                  				...
		                  				if (listNewses != null && listNewses.size() > 0) {
		                  					...
		                  					for (News itemNews : listNewses) {
		                  						boolean check = userLogin.getUserPermissions().getId() == 1 || userLogin.getId() == itemNews.getCreateBy();
		                  						if (check) {
		                  			%>
		                  			<tr role="row" class="odd">
					                    ...
					                    <%
					                    	...
					                    	String nameDisplay = itemNews.getName().replace(name, "<span style='color: red'>" + name + "</span>");
					                    %>
					                    <td><%=nameDisplay%></td>
					                    <td><%=sdf.format(itemNews.getDateCreate())%></td>
					                    <td>
					                    	<%if(!itemNews.getPicture().equals("")){%>
					                    	<img src="<%=request.getContextPath()%>/files/<%=itemNews.getPicture()%>" style="width: 100px; height: 100px;" />
					                    	<%}else{%>
		                    		...
		                    		%>
		                    		<tr><td colspan="8" style="text-align: center"><span style="color: red"><%=name%></span> not found.</td></tr>
		                    		<%
		                  				}
		                    		%>
								</tbody>
               		...
               		<div class="row">
               			<div class="col-sm-12 col-md-5">
               				<div class="dataTables_info" id="dataTable_info" role="status" aria-live="polite">
               					...
               					%>
               					Showing <%=from%> to <%=to%> of <%=numberOfItems%> newses found.
               				</div>
               			</div>
               			<div class="col-sm-12 col-md-7">
               				<div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
               					<ul class="pagination">
	               					<%
	                              		String href = request.getContextPath() + "/admin/news/search?name=" + name + "&page=";
	                              	%>
	                              	<!-- Xử lí nut previous -->
