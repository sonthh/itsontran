          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
	          <form action="" method="post" enctype="multipart/form-data">
	            ...
	            <div class="form-group">
				    ...
				    <select class="form-control" name="category" required="required">
					    <%
					    	...
					    	MenuCreationUtil.createOption(out, news.getCategory().getId(), -1);
					    %>
				    </select>
				</div>
				<div class="form-group">
				...
				%>
				<div class="form-group">
				    <img src="<%=request.getContextPath()%>/files/<%=news.getPicture()%>" alt="" class="img-thumbnail" style="width: 200px;">
				</div>
			    <%
			    	}
			    %>
